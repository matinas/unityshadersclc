...
* <span></span>**8. Normal Position Shader:** shades ab object based on each fragment normal's position (in world space). Based on "Combining Textures" tutorial.

* <span></span>**9. Diffuse Shader:** shades an object based on the diffuse light it receives from an only directional light. Based on "The First Light" tutorial.

* <span></span>**10. Diffuse Specular Shader:** shades an object based on the diffuse and specular light it receives from an only directional light. Based on "The First Light" tutorial.
